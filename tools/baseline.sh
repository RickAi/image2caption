...
cp merged_frozen_graph.pb ../android/Application/src/main/assets/merged_frozen_graph.pb

wget -c https://deepdetect.com/models/tf/inception_v4.pb
cp inception_v4.pb ../tensorflow/ConvNets
...
cp ./flickr30k/results_20130124.token ../tensorflow/Dataset/flickr30k-images
rm -rf ./flickr30k
